import { AoC2023Day9 } from './day9'
import path from 'path'
import fs from 'fs'

describe.only('AoC 2023 day 9', () => {
  let inputQ1: string
  let inputQ2: string
  ...
  it('should correctly answer question 1', () => {
    expect(AoC2023Day9(inputQ1).answerQuestion1).toBe(10)
  })

  it('should correctly answer question 2', () => {
    expect(AoC2023Day9(inputQ2).answerQuestion2).toBe(20)
  })
})
