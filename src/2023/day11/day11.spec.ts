import { AoC2023Day11 } from './day11'
import path from 'path'
import fs from 'fs'

describe('AoC 2023 day 11', () => {
  let inputQ1: string
  let inputQ2: string
  ...
  it('should correctly answer question 1', () => {
    expect(AoC2023Day11(inputQ1).answerQuestion1).toBe(374)
  })

  it('should correctly answer question 2', () => {
    expect(AoC2023Day11(inputQ2).answerQuestion2).toBe(82000210)
  })
})
